...
+ (NSString *) getCurrentTime {
    ...
    NSTimeZone* timeZone = [NSTimeZone systemTimeZone];//获取设置时区
    [formatter setTimeZone:timeZone];
    NSDate *datenow = [NSDate date];
    NSString *nowTime = [NSDate time_dateToString:datenow];
    NSLog(@"234");
    return nowTime;
}
...
//sencodsTime:时间戳。
//return：年份
+(NSString *)GetYearStringWithSeconds:(int)sencodsTime{
    NSDateFormatter* formatter = [[NSDateFormatter alloc] init];
    [formatter setDateStyle:NSDateFormatterMediumStyle];
    [formatter setTimeStyle:NSDateFormatterShortStyle];
    [formatter setDateFormat:@"yyyy-MM-dd HH:MM:ss"];//@"yyyy-MM-dd-HHMMss"
    NSDate* date = [NSDate dateWithTimeIntervalSince1970:sencodsTime];
    NSCalendar *calendar = [NSCalendar currentCalendar];
    NSUInteger unitFlags = NSCalendarUnitYear|NSCalendarUnitMonth |NSCalendarUnitDay|NSCalendarUnitHour|NSCalendarUnitMinute|NSCalendarUnitSecond;
    NSDateComponents *dateComponent = [calendar components:unitFlags fromDate:date];
    return [NSString stringWithFormat:@"%02ld",dateComponent.year];
}

//sencodsTime:时间戳。
//return：月份
+(NSString *)GetMonthStringWithSeconds:(int)sencodsTime{
    NSDateFormatter* formatter = [[NSDateFormatter alloc] init];
    [formatter setDateStyle:NSDateFormatterMediumStyle];
    [formatter setTimeStyle:NSDateFormatterShortStyle];
    [formatter setDateFormat:@"yyyy-MM-dd HH:MM:ss"];//@"yyyy-MM-dd-HHMMss"
...
//sencodsTime:时间戳。
//return：天
+(NSString *)GetDayStringWithSeconds:(int)sencodsTime{
    NSDateFormatter* formatter = [[NSDateFormatter alloc] init];
    [formatter setDateStyle:NSDateFormatterMediumStyle];
    [formatter setTimeStyle:NSDateFormatterShortStyle];
    [formatter setDateFormat:@"yyyy-MM-dd HH:MM:ss"];//@"yyyy-MM-dd-HHMMss"
